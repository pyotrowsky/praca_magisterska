...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(18438326815713639)
...
,p_reference_id=>308113769100442083
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(18438657253713642)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(18439033608713642)
,p_plugin_attribute_id=>wwv_flow_api.id(18438657253713642)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(18439518714713643)
,p_plugin_attribute_id=>wwv_flow_api.id(18438657253713642)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(18440058579713643)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
,p_attribute_scope=>'COMPONENT'
...
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(18438657253713642)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(18440463502713644)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(18441487120713646)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(18441805611713646)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(18442201520713647)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(18442688900713647)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(18443046327713647)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(18443473056713648)
,p_plugin_id=>wwv_flow_api.id(18438326815713639)
