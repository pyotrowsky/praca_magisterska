...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10767876947153781)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10768136027153782)
,p_plug_template_id=>wwv_flow_api.id(10767876947153781)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10768402992153782)
,p_plug_template_id=>wwv_flow_api.id(10767876947153781)
,p_name=>'Tabs'
