...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10761094506153773)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10761329723153773)
,p_plug_template_id=>wwv_flow_api.id(10761094506153773)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10761611179153773)
,p_plug_template_id=>wwv_flow_api.id(10761094506153773)
,p_name=>'Sub Regions'
