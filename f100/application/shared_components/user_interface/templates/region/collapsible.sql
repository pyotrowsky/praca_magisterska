...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10741423768153745)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741700543153746)
,p_plug_template_id=>wwv_flow_api.id(10741423768153745)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742017742153746)
,p_plug_template_id=>wwv_flow_api.id(10741423768153745)
,p_name=>'Sub Regions'
