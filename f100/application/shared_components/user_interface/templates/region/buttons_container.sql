...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10731075742153726)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10731354064153727)
,p_plug_template_id=>wwv_flow_api.id(10731075742153726)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10731603936153727)
,p_plug_template_id=>wwv_flow_api.id(10731075742153726)
,p_name=>'Sub Regions'
